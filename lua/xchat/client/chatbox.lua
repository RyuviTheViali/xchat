...
function XChat:SendMessage(...)
	if LocalPlayer():GetNWBool("xsys_gagged") and not ({...})[1]:sub(2,4) == "pm " then return end
	if xsys.xban and LocalPlayer():GetNWBool("XsysBanned") and not ({...})[1]:sub(2,4) == "pm " then return end
